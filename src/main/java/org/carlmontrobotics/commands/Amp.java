...
public class Amp extends Command{
  ...
  public boolean isFinished() {
    ...
    1. One to check if the motor speed or compression is different than the regular speed.  
       ...
       statement will return false.  If the statement is true, the Eject timer will stop 
       and reset
    2. This is a backup if statement if the motor if statement is not checking. 
       If 5 seconds has passed since pressing the right bumper and the other If statement hasn't 
